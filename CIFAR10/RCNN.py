...
if __name__ == "__main__":
    ...
    history = train_model.fit_generator(
        ...
        validation_data=val_generator, max_queue_size=128, workers=8, 
    ...
    print(test_result)
    '''
    input_tensor_test = tf.keras.Input(shape=(32, 32, 3))
    output_tensor_test = rcnn(input_tensor_test, False, 3)
    test_model = tf.keras.Model(input_tensor_test, output_tensor_test)
    test_model.summary()
