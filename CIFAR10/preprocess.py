...
print('CIFAR10 train dev samples:', train_dev_samples.shape)
print('CIFAR10 train dev labels:', train_dev_labels.shape)
test_samples, test_labels = test_data
test_labels = np.squeeze(test_labels)
print('CIFAR10 test samples:', test_samples.shape)
print('CIFAR10 test labels:', test_labels.shape)
